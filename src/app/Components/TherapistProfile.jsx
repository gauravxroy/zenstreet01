...
const TherapistProfile = () => {
  ...
  const testimonials = [
    {
      text:
        "The guidance I received helped me through my stress and fears more than I ever expected to.",
      author: "Anonymous",
    },
    {
      text:
        "Simply helped me heal self-esteem and confidence that I never thought possible.",
      author: "Anonymous",
    },
    {
      text:
          ...
          <div className="lg:col-span-8 p-4 lg:p-8">
            <section className="mb-6">
              ...
              <p className="text-gray-600 text-sm">
                Hello, I am Swetha, a licensed therapist dedicated to guiding
                individuals through life challenges with empathy and expertise.
                With over 4 years of experience, I specialize in helping clients
